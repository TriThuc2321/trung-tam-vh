...
export const coreValues = [
  {
    title: "Thấu cảm",
    description:
      "Lắng nghe, thấu hiểu và đồng hành cùng trẻ trong mọi giai đoạn phát triển.",
  },
  {
    title: "Cá nhân hoá",
    description:
      "Mỗi trẻ là duy nhất — chương trình được thiết kế phù hợp với năng lực và nhu cầu riêng.",
  },
  {
    title: "Chuyên môn",
    description:
      "Đội ngũ chuyên gia giàu kinh nghiệm, được đào tạo bài bản về tâm lý và giáo dục đặc biệt.",
  },
  {
    title: "Đồng hành",
    description:
      "Phối hợp chặt chẽ giữa chuyên gia, gia đình và nhà trường để hỗ trợ trẻ toàn diện.",
  },
];
